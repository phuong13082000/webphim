                    ...
                    <div class="card-body">
                        ...
                        <div class="m-3">
                            <div class="form-group">
                                ...
                                {!! Form::text('thoiluong', isset($movie) ? $movie->thoiluong : '', ['class'=>'form-control', 'id'=>'slug']) !!}
                            </div>
                        </div>
                        ...
                        <div class="m-3">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('tags', isset($movie) ? $movie->tags : '', ['style'=>'resize:none', 'class'=>'form-control']) !!}
                            </div>
                        </div>
